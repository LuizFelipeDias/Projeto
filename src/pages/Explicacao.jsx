...
const Explicacao = () => {
  return (
    <div className="page__content">
      <div className='container-code-explanation'>
        <div className='explanation-TAD' id="TAD">
  ...
  int desempilhar(Pilha *p, int *valor);
      ...
      <div className='container-pilha-explanation' id="Pilha">   
        <div className='pilha-explanation'>
          <h2>Pilha</h2>
  ...
  int desempilhar(Pilha *p, int *valor) {
    ...
    *valor = p->dados[(p->topo)--];
    return 1;
      ...
      <div className='container-buscabinaria-explanation' id="BuscaBinaria">
        <div className='buscabinaria-explanation'>
  ...
  {`int busca_binaria(int v[], int n, int x) {
    ...
    return -1;
      ...
      <div className='container-fila-explanation' id="Fila">
        <div className='fila-explanation'>
          <h2>Fila</h2>
...
int desenfileirar(Fila *f, int *x) {
  ...
  *x = f->dados[f->inicio];
  ...
  return 1;
      ...
      <div className='container-listaencadeada-explanation' id="ListaEncadeada">
        <div className='listaencadeada-explanation'>
  ...
  void inserir_inicio(No **inicio, int valor) {
    ...
    *inicio = novo;
    ...
    <div className='container-arvorebinaria-explanation' id="ArvoreBinaria">
      <div className='arvorebinaria-explanation'>
